...
class SoftTokenIdentifierWithQueryString
{
...
//            }
                ...
                $this->AccessToken = $this->GetTokenFromRequestQueryString($keyword, $prefix);
            }
...
//            dd($ex);
    ...
    protected function GetTokenFromRequestQueryString($keyWord, $prefix)
    {
        ...
        if ((is_array($keyword)) and (is_array($prefix))) {
            if (count($keyword) != count($prefix)) {
                ...
                foreach ($keyword as $key => $value) {
                    $AccessToken = $this->GetTokenFromRequestQueryString($value, $prefix[$key]);
                    $this->status = null;
            ...
            $AccessToken = $this->GetTokenFromRequestQueryString($keyword, $prefix);
            $this->status = null;
            $this->AccessToken = $AccessToken;
        }
    }
